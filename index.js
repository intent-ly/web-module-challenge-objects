...
function createMenuItem(nombre, cost, categories){
    return{
      name: nombre,
      price: cost,
      category: categories
...
createMenuItem('Chicken Sandwich', 5, 'Lunch');
createMenuItem('Chicken Nuggets', 6, 'Lunch');
createMenuItem('Soda', 2, 'Drinks');
...
const burger = {
  ...
  discount: function(string){
    if(string=='teacher'||string==='student'){
      return this.price * this.schoolDiscount;
    }
    else if(string==='public'){
      return this.price * this.publicDiscount;
  }
}
}
...
reviews.push({name:"Max", rating:3.3, feedback:"I like trains!"});
